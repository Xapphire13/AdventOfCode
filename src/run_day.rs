...
fn main() {
    ...
    match (year, day_num) {
        ...
        (2024, 17) => run_day_solution(years::aoc_2024::day17::Day17, input),
        (2024, 18) => run_day_solution(years::aoc_2024::day18::Day18, input),
        (2024, 19) => run_day_solution(years::aoc_2024::day19::Day19, input),
        (2024, 20) => run_day_solution(years::aoc_2024::day20::Day20, input),
        (2024, 21) => run_day_solution(years::aoc_2024::day21::Day21, input),
        (2024, 22) => run_day_solution(years::aoc_2024::day22::Day22, input),
        (2024, 23) => run_day_solution(years::aoc_2024::day23::Day23, input),
        (2024, 24) => run_day_solution(years::aoc_2024::day24::Day24, input),
        (2024, 25) => run_day_solution(years::aoc_2024::day25::Day25, input),
